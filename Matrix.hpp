...
private:
    ...
    bool check() const;
    friend void memset(Matrix &m, const size_t rows, const size_t cols, const float data);
    friend void memcpy(Matrix &m1, const Matrix &m2);
...
public:
    ...
    friend bool operator!=(const Matrix &m1, const Matrix &m2) { return !operator==(m1, m2); }
